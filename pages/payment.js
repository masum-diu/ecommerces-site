...
const payment = () => {
  ...
  return (
    <>
      {
        payment == 'success' ? <><Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", width: "90vw", maxWidth: "800px", margin: "0 auto", height: "100vh", }}>
        ...
        </Box></> : <> <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", width: "90vw", maxWidth: "800px", margin: "0 auto", height: "100vh", }}>
       
          <Paper sx={{ p: 4, width: "90vw", maxWidth: "800px", margin: "0 auto", }} elevation={3} >
            <Stack direction={"column"} sx={{ justifyContent: "center", alignItems: "center", }} spacing={2}>
              {/* <Typography variant="login1" color="initial" className='bold'>Your order has been received</Typography> */}
              <BiError style={{ fontSize: '50px', color: "red" }} />
              <Typography variant="header1" color="initial">Your payment failed</Typography>
              <Typography variant="legend" color="initial" className='SemiBold'>Please try failed</Typography>
